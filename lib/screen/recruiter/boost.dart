...
class RecruiterBoostController extends GetxController {
  ...
  Future<void> _finishBoost() async {
    ...
    try {
      ...
      final int index = listController.allJobs.indexWhere(
...
class RecruiterBoostPage extends StatelessWidget {
  ...
  final RecruiterBoostController controller = Get.put(
    RecruiterBoostController(),
  );
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 24),
                  const Text(
                    "Untuk Apa Boost Lowongan Kerja?",
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  title,
                  style: TextStyle(
                    fontWeight: controller.selectedPaymentIndex.value == index
                        ? FontWeight.bold
                        : FontWeight.normal,
                  ),
                ),

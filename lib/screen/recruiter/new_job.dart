    ...
    try {
      ...
      await vacancyRepository.add(
        JobVacancy(
          ...
          startDate: inReviewDate,
          endDate: null,
          recruiterId: authRepository.getUserId()!,
          jobType: jobType.value,
          workPolicy: workPolicy.value,
          salary: salary.value,
          minAge: minAge.value,
          skill: skill.value,
          minEducation: minEducation.value,
        ),
      );
      Get.back();
      Get.snackbar(
        "Sukses",
        "Lowongan dikirim untuk direview",
